...
export default function Item({ item, onClick = () => { }, className = '' }) {
    return (
        // <div onClick={() => onClick()} className='flex gap-2 mt-4 rounded-xl p-3 shadow-xl items-center cursor-pointer'>
        //     <img className='w-[132px] max-h-[70px] rounded-xl' alt={item?.title} src='https://via.placeholder.com/600/cde4c1' />
        //     <div className={`max-w-[420px] ${className}`}>
        //         <h1 className='text-sm font-bold mb-4 truncate'>
        //             {item?.title}
        //         </h1>
